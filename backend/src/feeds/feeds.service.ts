    ...
    return this.prisma.$queryRaw<NearbyRow[]>(Prisma.sql`
      WITH candidates AS (
        SELECT d.id, d.title, d.merchant, cat.slug AS category_slug,
               ...
               d.status, d.confidence_score, d.quality_score, d.image_url, d.campus_slug, d.requires_student_id,
               d.audience, d.campus_deal_type, d.created_at, d.start_at, d.expires_at,
